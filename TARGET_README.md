...
2. Clone the repo
   ```sh
   git clone https://github.com/mathiasb/libby_slack.git
   ```
...
See the [open issues](https://github.com/mathiasb/libby_slack/issues) for a full list of proposed features (and known issues).
...
[license-url]: https://github.com/mathiasb/libby_slack/blob/master/LICENSE.txt
